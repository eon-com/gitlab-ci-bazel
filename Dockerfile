...
RUN wget https://dl.google.com/go/go1.16.6.linux-amd64.tar.gz && tar -xvf go1.16.6.linux-amd64.tar.gz && mv go /usr/local/go && rm go1.16.6.linux-amd64.tar.gz && echo "export PATH=\$PATH:/usr/local/go/bin" >> ~/.bashrc
